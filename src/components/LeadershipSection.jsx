...
const cvData = {
  ...
  'Ing. Jair Molina Arce': {
    ...
    cvPdf: '/cv_assic.pdf',
    title: {
      en: 'IoT Engineer, Home Automation & Full-Stack Software Developer',
      es: 'Ingeniero en IoT, Domotica y Desarrollo de Software Full-Stack',
    },
    bio: {
      en: 'Mechanical Engineer with solid experience in IoT, home automation, embedded systems, and full-stack software development. Expert in integrating hardware and software in connected solutions: from firmware on microcontrollers (ESP32, STM32) to deploying web platforms on the cloud with RESTful APIs and real-time dashboards. Speaker at international congresses and author of scientific publications. Currently pursuing a master in advanced technologies focused on dynamic systems control and instrumentation at IPN.',
      es: 'Ingeniero Mecanico con solida experiencia en IoT, domotica, sistemas embebidos y desarrollo de software full-stack. Especialista en integrar hardware y software en soluciones conectadas: desde firmware en microcontroladores (ESP32, STM32) hasta el despliegue de plataformas web en la nube con APIs RESTful y dashboards en tiempo real. Ponente en congresos internacionales y autor de publicaciones cientificas. Actualmente cursa maestria en tecnologias avanzadas con enfoque en control de sistemas dinamicos e instrumentacion en el IPN.',
    },
    education: [
      'M.Sc. in Advanced Technologies - IPN (2024 - Present)',
      'B.Eng. in Mechanical Engineering - IPN (2017 - 2023)',
      'Technical Baccalaureate in Computer Science - Colegio de Bachilleres (2014 - 2017)',
    ],
    experience: {
      en: [
        'Principal Architect at Co.De Aerospace — full-stack IoT platforms and web systems.',
        'Speaker and co-author at the 75th International Astronautical Congress (IAC 2024), Milan, Italy.',
        'Full-stack IoT platform development: Flask, SQLAlchemy, Docker, REST APIs, JWT auth, MySQL/Redis.',
        'Graduate-level instructor on Disruptive Technologies (VR/AR) at ENBA-IPN (2024).',
        'Embedded systems instrumentation for propulsion test bench: ESP32/STM32, DAQ, MATLAB/Simulink.',
        'National publication in "Hacia el Espacio" magazine; technology communicator on TV Azteca Mexico (2024).',
        'Head of Staff at ICASST 2023; Organizing Committee at ICASST 2022.',
      ],
      es: [
        'Arquitecto Principal en Co.De Aerospace — plataformas IoT full-stack y sistemas web.',
        'Ponente y coautor en el 75th International Astronautical Congress (IAC 2024), Milan, Italia.',
        'Desarrollo de plataforma IoT full-stack: Flask, SQLAlchemy, Docker, APIs REST, autenticacion JWT, MySQL/Redis.',
        'Docente de posgrado en Tecnologias Disruptivas (VR/AR) en la ENBA-IPN (2024).',
        'Instrumentacion de sistemas embebidos para banco de pruebas de propulsion: ESP32/STM32, DAQ, MATLAB/Simulink.',
        'Publicacion nacional en la revista "Hacia el Espacio"; divulgador tecnologico en TV Azteca Mexico (2024).',
        'Jefe de Staff en ICASST 2023; Comite Organizador en ICASST 2022.',
      ],
    },
    skills: ['IoT / ESP32 / STM32', 'Python', 'C/C++', 'Flask / REST APIs', 'React', 'Docker', 'MATLAB/Simulink', 'Embedded Systems', 'ANSYS / FEA', 'Control Systems', 'VR/AR', 'SmartCity'],
...
const LeadershipSection = () => {
  ...
  const fallbackLeaders = useMemo(() => [
    ...
    },
    {
      ...
      content: {
        en: {
          title: 'IoT Engineer & Full-Stack Software Developer',
          role: 'IoT, home automation, embedded systems & full-stack development',
          description: ['IAC 2024 speaker and co-author, Milan Italy', 'IoT platform dev: Flask, Docker, ESP32/STM32', 'Graduate instructor: VR/AR Disruptive Technologies at IPN'],
        },
        es: {
          title: 'Ingeniero IoT y Desarrollador de Software Full-Stack',
          role: 'IoT, domotica, sistemas embebidos y desarrollo full-stack',
          description: ['Ponente y coautor en IAC 2024, Milan Italia', 'Plataforma IoT: Flask, Docker, ESP32/STM32', 'Docente de posgrado: Tecnologias Disruptivas VR/AR en IPN'],
        },
      },
      icon: Code,
    },
